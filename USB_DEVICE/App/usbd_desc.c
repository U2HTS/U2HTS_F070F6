...
#define USBD_PRODUCT_STRING_FS "U2HTS USB to HID Touchscreen"
#define USBD_CONFIGURATION_STRING_FS "U2HTS HID Config"
#define USBD_INTERFACE_STRING_FS "U2HTS HID Interface"
